...
from .objects import AccessToken, User, Guild, Permissions, convert_guild, convert_user
import typing as t
...
class Auth(object):
    ...
    def get_guild(self, token: AccessToken, guild_id) -> t.Optional[t.Union[Guild, dict]]:
        r = request(
            method="GET", 
